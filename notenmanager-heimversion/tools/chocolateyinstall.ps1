...
$url64      = 'https://software.notenmanager.net/NMHV3Setup.exe' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'notenmanager_heimversion*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  ...
  checksum64    = 'C8F5BF097A42DDD1CF1AAF84CA760687160B0D7F1150E2738548BC4007918724'
