...
$url        = 'http://friedrich-folkmann.de/papdesigner/v2.2.0.8.08/PapDesigner-Setup.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'papdesigner*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
