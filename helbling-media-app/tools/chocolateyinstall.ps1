...
$url        = 'https://mediaapp.helbling.com/downloads/OU34DJKB/latest/HELBLING%20Media%20App%20Setup.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'helbling-media-app' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  ...
  checksum64    = 'b5493040094f0de26dcef144cddb8b81'
